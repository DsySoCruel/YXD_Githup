...
- (void)setModel:(TZAlbumModel *)model {
    ...
    NSAttributedString *countString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"  (%tu)",model.count] attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16],NSForegroundColorAttributeName:[UIColor lightGrayColor]}];
    ...
    if (model.selectedCount) {
        ...
        [self.selectedCountButton setTitle:[NSString stringWithFormat:@"%tu",model.selectedCount] forState:UIControlStateNormal];
    } else {
