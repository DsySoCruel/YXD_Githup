...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    if (self.pickerViewMode == DatePickerViewDateTimeMode) {
        ...
        _string =[NSString stringWithFormat:@"%tu-%.2ld-%.2ld %.2ld:%.2ld",selectedYear,selectedMonth,selectedDay,selectedHour,selectedMinute];
    }else if (self.pickerViewMode == DatePickerViewDateMode){
        switch (component) {
            case 0:
            {
        ...
        _string =[NSString stringWithFormat:@"%tu-%.2ld-%.2ld",selectedYear,selectedMonth,selectedDay];
    }else if (self.pickerViewMode == DatePickerViewTimeMode){
        switch (component) {
            case 0:
            {
